        ...
        <Formik onSubmit={onSubmitHandler} initialValues={initialValues} validationSchema={validationSchema}>
            {({values,setFieldValue,handleSubmit})=>(
              <>  
                ...
                <Field name="name" id="name" type="text" placeholder='Enter Consumer Name' className="w-full my-2 border-2 outline-none py-3 px-4 rounded-lg" />
              ...
              <div className="mb-3">
                ...
                <Field name="email" id="email" type="text" placeholder='Enter Consumer Email' className="w-full my-2 border-2 outline-none py-3 px-4 rounded-lg" />
              ...
              <div className="mb-3">
                ...
                <Field name="mobile" id="mobile" type="text" placeholder='Enter Consumer Mobile' className="w-full my-2 border-2 outline-none py-3 px-4 rounded-lg" />
              ...
              <div className="mb-3">
                ...
                <Calendar className='w-full my-2 border-2 outline-none py-3 px-4 ring-0 rounded-lg' maxDate={new Date()} inputClassName='outline-none ring-0' placeholder='Enter Consumer DOB' dateFormat='dd/mm/yy' value={values.dob}  onChange={(e)=>{
              ...
              <div className="mb-3">
                ...
                <Field as="textarea" rows={3} name="address" id="address" type="text" placeholder='Enter Consumer Address' className="w-full my-2 border-2 outline-none py-3 px-4 rounded-lg" />
                <ErrorMessage name='address' className='text-red-500 capitalize' component={'p'} />
              </div>
                      <div className="flex justify-end">
                  <Button loading={RegisterConsumerResponse.isLoading} className="text-white px-5 bg-accent py-3 text-center rounded-lg ">Add Consumer</Button>
                        </div>

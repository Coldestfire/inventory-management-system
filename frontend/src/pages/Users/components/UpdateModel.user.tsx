...
const UpdateModel = ({ visible ,setVisible,_id}:any) => {
  ...
  return (
    <>
          ...
          <Dialog draggable={false} visible={visible} className=' w-[90%] mx-auto lg:mx-0 lg:w-1/2' onHide={() => setVisible(false)} header="Update Consumer Details">
                          ...
                          <form onSubmit={handleSubmit} className="w-full" >
                              ...
                              <div className="flex justify-end">
                                  <Button
                                      ...
                                      className="text-white px-5 rounded-lg bg-accent py-3 text-center ">Update Consumer</Button>
                              </div>
